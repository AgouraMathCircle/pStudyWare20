...
{
    /// <summary>
    /// Repository implementation for SystemAdmin dashboard data access operations
    /// </summary>
    public class SystemAdminRepository : ISystemAdminRepository
    {
        ...
        public SystemAdminRepository(AMC_DBContext context, IConfiguration configuration)
        {
            _context = context;
