    ...
    public class SemesterLookupService : ISemesterLookupService
    {
        ...
        private static SemesterLookupDto MapRow(DataRow row)
        {
            return new SemesterLookupDto
            {
                ...
                SemesterName = Cell(row, "SemesterName", "semesterName"),
                NextSemester = Cell(row, "NextSemester", "nextSemester"),
                LastSemesterName = Cell(row, "LastSemesterName", "lastSemesterName"),
                NextSemesterName = Cell(row, "NextSemesterName", "nextSemesterName"),
