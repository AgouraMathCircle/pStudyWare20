        ...
        <Box sx={{ 
          ...
          <Box sx={{ 
            ...
            <Box sx={{ textAlign: { xs: "center", md: "left" } }}>
              ...
              >
                See what our students and their parents have to say about their experience with Agoura Math Circle.
              </Typography>
            </Box>
          </Box>
          ...
          <Box sx={{ 
            ...
            position: 'relative',
            overflow: 'hidden',
            height: '240px', // Adjusted height for a single row of videos
          }}>
