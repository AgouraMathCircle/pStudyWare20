...
import "../../../styles/SystemAdminUserTracking.css";
...
const SystemAdminUserTracking = () => {
  ...
  const loadList = useCallback(async () => {
    ...
    try {
      setLoading(true);
      const res = await systemAdminDashboardService.getUserTrackingList({
...
export default SystemAdminUserTracking;
