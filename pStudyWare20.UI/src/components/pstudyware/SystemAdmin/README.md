...
### systemAdminDashboardService.js

**Service for making API calls to the SystemAdminDashboardController**
...
function App() {
  return (
    <Routes>
      <Route
        path="/pstudyware/systemadmin/dashboard"
        element={
          <RoleProtectedRoute
      ...
      />
      <Route
        path="/pstudyware/systemadmin/instructors"
        element={
          <RoleProtectedRoute
            allowedRoles={["Admin", "SystemAdmin"]}
            allowedMemberTypes={["A"]}
      ...
      />
      <Route
        path="/pstudyware/systemadmin/registered-students"
        element={
          <RoleProtectedRoute
            allowedRoles={["Admin", "SystemAdmin"]}
            allowedMemberTypes={["A"]}
...
The SystemAdminDashboard component:
...
- `GET /api/SystemAdminDashboard/GetDashboardData`: Get all dashboard data
- `POST /api/SystemAdminDashboard/GetStudentList`: Get student list
- `POST /api/SystemAdminDashboard/GetUserTrackingSummary`: Get tracking summary
- `POST /api/SystemAdminDashboard/GetDashboardMessage`: Get dashboard message
- `POST /api/SystemAdminDashboard/PublishDocument`: Publish documents
- `POST /api/SystemAdminDashboard/ExportStudentListToExcel`: Export to Excel
- `GET /api/SystemAdminDashboard/CheckAdminPrivileges`: Check admin privileges
...
- `src/styles/SystemAdminDashboard.css`
