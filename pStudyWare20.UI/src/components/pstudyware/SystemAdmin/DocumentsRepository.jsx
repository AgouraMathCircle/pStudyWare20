...
import SystemAdminDocumentsRepositoryList from "./SystemAdminDocumentsRepositoryList";
import DocumentRepositoryUploadForm from "./DocumentRepositoryUploadForm";
          ...
          <Grid container spacing={3}>
            <Grid item xs={12}>
              <Card sx={adminSessionListPanelCardSx}>
                ...
                >
                  <SystemAdminDocumentsRepositoryList
