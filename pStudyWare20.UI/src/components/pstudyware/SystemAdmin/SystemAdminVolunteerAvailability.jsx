...
import "../../../styles/SystemAdminVolunteerAvailability.css";
...
const SystemAdminVolunteerAvailability = () => {
  const { user } = useAuth();
          ...
          <Grid item xs={12}>
            <Card sx={adminSessionListPanelCardSx}>
              <CardContent sx={adminSessionListPanelContentSx}>
                ...
                <SystemAdminVolunteerAvailabilityGrid
                  rows={rows}
                  loading={loading}
                  error={error}
                />
...
export default SystemAdminVolunteerAvailability;
