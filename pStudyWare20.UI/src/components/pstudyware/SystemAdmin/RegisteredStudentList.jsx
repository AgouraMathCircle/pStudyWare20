...
const REGISTERED_STUDENT_LIST_REFERRERS = {
  "message-center": {
    ...
    pathSuffix: "/message-center",
  },
  "student-waiting-list": {
    label: "Back to Student Waiting List",
    pathSuffix: "/Studentwaiting-list",
  },
};
...
const RegisteredStudentList = () => {
  ...
  const listReferrer = useMemo(() => {
    ...
    const referrer = REGISTERED_STUDENT_LIST_REFERRERS[from];
    if (!referrer) return null;
    return {
      label: referrer.label,
      path: toSystemAdminPortalPath(location.pathname, referrer.pathSuffix),
    };
