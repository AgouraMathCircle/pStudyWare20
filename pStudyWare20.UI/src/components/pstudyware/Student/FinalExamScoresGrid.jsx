...
const FinalExamScoresGrid = ({ scores = [], embedded = false, loading = false }) => {
  ...
  const title = (
    <Typography variant="subtitle1" sx={{ ...adminSessionListTitleSx, mb: 0.5 }}>
      Your Scores
    </Typography>
  );
...
export default FinalExamScoresGrid;
