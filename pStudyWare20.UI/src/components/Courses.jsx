  ...
  return (
    <Box
      sx={{
        ...
        padding: { xs: "24px 0 40px 0", md: "54px 0 110px 0" }, // Increased top padding to move section down a bit
      }}
    >
      <Container maxWidth="lg">
        ...
        <Box
          sx={{
            ...
            mt: 0, // Remove negative margin so header stays down
          }}
        >
          <Typography
            variant="h6"
          ...
          <Grid item xs={12} md={6} lg={4} sx={{ display: "flex", justifyContent: "center" }}>
            ...
            >
              <CardMedia
                component="img"
                image={scheduleImage}
                alt="Fall Semester 2026 Schedule"
                sx={{
                  height: "200px",
                  objectFit: "cover",
                }}
              ...
              >
                ...
                <List sx={{ padding: 0 }}>
                  ...
                  <ListItem sx={{ padding: "4px 0" }}>
                    <ListItemText
                      primary="12/19/2026 : 12.00 - 5.00 PM FINAL EXAM"
                      sx={{
                        "& .MuiListItemText-primary": {
                          fontSize: "14px",
                          color: "#505050",
