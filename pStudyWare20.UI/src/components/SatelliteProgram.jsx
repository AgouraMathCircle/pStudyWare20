      ...
      >
        <div className="container">
          ...
          <div className="row overview-text-row">
            <div className="col-lg-6" style={{ marginLeft: "-12px" }}>
              <div className="sec-title mb-20">
                <div
                  className="des-sec about-cont"
                  style={{ fontSize: "17px", paddingLeft: 0 }}
                >
                  Agoura Math Circle is proud to introduce its groundbreaking
                  initiative, the "Satellite Program," aimed at collaborating
                  with schools/educational institutions, students, and teachers
                  with a shared passion for problem-solving using mathematics
                  and computer science on a global scale. As part of this
                  initiative, we would create a platform for students and
                  teachers and help build a club or study circle or enrichment
                  classes in their respective schools/educational institutions.
                  We will offer a range of resources, including online study
                  material, live lectures, interactive workshops, access to a
                  diverse team of expert mentors. Our program's curriculum will
                  cover a wide spectrum of mathematical and computer science
                  topics, from foundational concepts to cutting-edge
                ...
                <div
                  ...
                  style={{ fontSize: "17px", paddingLeft: 0 }}
                >
                  Together, we believe in the transformative power of education
                  to build a more equitable and inclusive world, where the joy
                  of problem-solving is accessible to all at no cost. Together,
                  we can inspire the problem solvers of tomorrow and drive
          ...
          >
            <div className="col-lg-12 text-center mb-4">
              ...
              >
                <img
                  src={satelliteLogoAboutImg}
                  alt="Sai Krushna Charitable Trust Logo"
                  className="overview-image"
                />
              </div>
              <div
