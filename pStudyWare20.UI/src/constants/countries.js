/**
 * List of countries for dropdowns and forms
 * Sorted by common usage first, then alphabetically
 */
...
/**
 * Helper function to get country label by country code
 * @param {string} code - Two-letter country code
 * @returns {string} Country label or code if not found
 */
...
/**
 * Helper function to get country code by country label
 * @param {string} label - Country label
 * @returns {string} Country code or label if not found
 */
