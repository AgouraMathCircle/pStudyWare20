CREATE TABLE [dbo].[AMC_tblLookupSemester](
	...
	[OnlineExamDisplayChapter] [char](10) NULL,
...
ALTER TABLE [dbo].[AMC_tblLookupSemester] ADD  CONSTRAINT [DF_AMC_tblLookupSemester_LastSemesterName]  DEFAULT ('') FOR [LastSemesterName]
GO

ALTER TABLE [dbo].[AMC_tblLookupSemester] ADD  CONSTRAINT [DF_AMC_tblLookupSemester_NewSemesterName]  DEFAULT ('') FOR [NextSemesterName]
