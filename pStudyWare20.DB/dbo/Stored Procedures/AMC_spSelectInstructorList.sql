...
---------------Declare ----------------------------------------------
Declare @SuperUser char(1)
---------------Assign Values-----------------------------------------
Set @SuperUser='N'
Select @SuperUser =SuperUser from MemberMaster with (NOLOCK)  where upper(ltrim(Username))=upper(ltrim(@Username))
---------------Finding the Last Login--------------------------------
